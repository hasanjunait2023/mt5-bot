...
echo          GBPUSD XAUUSD
echo   Risk : 1%% per trade  ^|  Daily DD limit: 20.0%%
echo ================================================================
echo.
...
python mt5_bridge/mtf_live_trader.py --pairs CADJPY EURJPY USDJPY GBPAUD BTCUSD AUDNZD USDCAD EURUSD AUDCHF NZDUSD EURNZD NZDJPY AUDCAD GBPJPY AUDUSD AUDJPY GBPUSD XAUUSD --risk 1.0 --dd 20.0 --maxdd 50.0 --maxtd 6
