...
export function EquityMiniChart({ data, height = 48 }: Props) {
  if (data.length < 2) return <div style={{ height }} className="bg-bg-elevated rounded" />
    ...
    <ResponsiveContainer width="100%" height={height}>
      <AreaChart data={data} margin={{ top: 2, right: 0, left: 0, bottom: 2 }}>
        ...
        <Tooltip
          ...
          labelStyle={{ color: '#8896a8', fontSize: 10 }}
          itemStyle={{ color: '#e8ecf4', fontFamily: 'monospace', fontSize: 11 }}
