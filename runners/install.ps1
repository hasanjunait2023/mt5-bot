...
#  Usage: powershell -File runners\install.ps1
# ============================================================
...
Write-Host "   3. Run: .\runners\start_bot.ps1  to start trading" -ForegroundColor White
Write-Host "   4. Run: .\runners\start_dashboard.ps1  to open dashboard" -ForegroundColor White
Write-Host "=================================================" -ForegroundColor Cyan
Write-Host ""
